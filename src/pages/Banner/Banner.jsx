...
const Banner = () => {
  return (
    <div className="p-5 lg:p-0 mb-5 z-10 mt-10">
      <div className="carousel w-full h-[400px] mt-4">
        {/* Slide 1 */}
        <div id="slide1" className="carousel-item relative w-full">
          <img
            ...
            alt="Slide 1"
          />
          <div className="absolute mt-[100px] lg:ml-20 ml-5 z-10">
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img
            ...
            alt="Slide 2"
          />
          <div className="absolute mt-[100px]  lg:ml-20 ml-5">
            <h2 className="lg:text-4xl text-xl text-white font-bold">
        ...
        <div id="slide3" className="carousel-item relative w-full">
          ...
          />
          <div className="absolute mt-[100px] lg:ml-20 ml-5">
            <h2 className="lg:text-4xl text-xl text-black font-bold">
        ...
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <div className="absolute mt-[100px] lg:ml-20 ml-5">
            ...
            <p className="text-white lg:text-2xl text-sm mt-5 w-2/3">
              Launch, manage, and scale your fundraising campaigns with ease.
