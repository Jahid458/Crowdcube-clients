...
const CampaigCard = ({campaignList}) => {
  const {imageURL,campaignTitle,campaignType,description,_id} = campaignList;
  return (
    <div className="card w-full lg:w-96 bg-base-100 shadow-2xl mb-5 ">
    {/* Card Image */}
    <figure>
      <img src={imageURL} alt="Campaign" className="w-full h-[300px] object-cover" />
    </figure>
    ...
    <div className="card-body">
      ...
      <Link to={`/campaignDetails/${_id}`}>
        <button className="btn bg-orange-600 text-white font-bold text-2xl lg:px-4 px-12">See More</button>
